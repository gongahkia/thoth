...
- Added multiple dungeon locations, location-specific enemies/bosses/curios, diseases and treatment, combat target hitboxes, estate mouse controls, loot capacity, and estate week cadence.
...
- Add gather/activate quest types, more layouts, more bosses, and more long-form campaign pressure.
- Add explicit estate controls for training, gear, trinkets, quirk/disease treatment, and party rank assignment.
