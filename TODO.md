...
- Expedition loop: choose mission tiers, move, scout rooms, manage light/provisions/hunger, resolve curios and traps, gather/activate quest objects, camp, fight rank-based encounters, return to estate.
...
- Added multiple dungeon locations, location-specific enemies/bosses/curios, gather/activate missions, diseases and treatment, combat target hitboxes, fallen-trinket recovery, estate mouse controls, exact roster controls, loot capacity, estate week cadence, town events, selectable stress recovery activities, quirk growth/locking, virtue variety, and persistent campaign pressure.
