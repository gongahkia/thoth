...
- Gameplay now has supply contracts from first plates through rift travel, biome contracts, deterministic authored Marsh/Desert/Badlands/Snowfield/Crystal lairs plus seeded procedural lairs beyond the starter ring, lair-specific hostile pressure, prepared boss summons, boss relic rewards, powered outpost beacons, local-biome scout routing from remote logistic ports, powered guard/arc towers, repair pylons, pressure relays, a deterministic factory-pressure score with factory-anchored hostile waves after meaningful science production, repeatable post-victory expedition goals, and an explicit main-objective completion state.
...
- Tune the repeatable post-victory campaign spine across scouting, relics, storms, outpost deliveries, pressure rewards, lair caches, freight, scrap recycling, and powered mining.
...
- Expand fair defense tuning around factory-anchored pressure: alert UI, wave cadence, structure-damage tuning, and tests proving raids stay deterministic.
...
1. Playtest supply contracts, biome contracts, procedural lair density, local-biome scouting, factory-anchored pressure, tower cadence, support-machine power demand, boss HP, boss summon costs, and reward usefulness in one continuous run.
2. Tune repeatable post-victory contracts that reuse outposts, relics, rift-band expansion, freight, scrap recycling, and powered mining.
