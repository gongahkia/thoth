...
tests[#tests + 1] = function()
    ...
    expect(loadedPort.inventory:count("cactus_fiber") >= 2, "completed scout should return biome material")
    expect(loaded.productionTotals.scout_dispatches == 1, "scout dispatch total should increment")
    expect(loaded.productionTotals.scout_materials_recovered == 2, "scout material recovery should increment")
