...
build = {
   ...
   modules = {
      ...
      ["thoth.game.animation"] = "thoth/game/animation.lua",
      ["thoth.game.camera"] = "thoth/game/camera.lua",
      ["thoth.game.collision"] = "thoth/game/collision.lua",
      ["thoth.game.frame"] = "thoth/game/frame.lua",
      ["thoth.game.input"] = "thoth/game/input.lua",
      ["thoth.game.navigation"] = "thoth/game/navigation.lua",
      ["thoth.game.pathfinding"] = "thoth/game/pathfinding.lua",
      ["thoth.game.tilemap"] = "thoth/game/tilemap.lua",
