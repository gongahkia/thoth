...
const std::vector<TileDef> kTiles = {
    ...
    {TileId::Sand, "sand", "Sand", 1, true, true, ItemId::Sand, Rgb{198, 178, 108}},
    {TileId::Beach, "beach", "Beach", 1, true, true, ItemId::Shell, Rgb{218, 196, 122}},
    {TileId::Snow, "snow", "Snow", 1, true, true, ItemId::None, Rgb{214, 226, 226}},
    {TileId::Ice, "ice", "Ice", 2, true, true, ItemId::IceShard, Rgb{154, 218, 230}},
    {TileId::Mud, "mud", "Mud", 1, true, true, ItemId::None, Rgb{98, 88, 58}},
    {TileId::Reeds, "reeds", "Reeds", 1, true, false, ItemId::ReedFiber, Rgb{76, 138, 72}},
    {TileId::Cactus, "cactus", "Cactus", 2, false, false, ItemId::CactusFiber, Rgb{60, 142, 82}},
    {TileId::Stone, "stone", "Stone", 3, true, true, ItemId::Stone, Rgb{130, 138, 134}},
    {TileId::Basalt, "basalt", "Basalt", 4, true, true, ItemId::Basalt, Rgb{82, 84, 91}},
    {TileId::Crystal, "crystal", "Crystal", 4, false, false, ItemId::Crystal, Rgb{112, 210, 218}},
    ...
    {TileId::DeepWater, "deep_water", "Deep Water", 2, false, false, ItemId::Kelp, Rgb{30, 82, 150}},
    {TileId::Coral, "coral", "Coral", 2, false, false, ItemId::CoralShard, Rgb{214, 100, 124}},
    ...
    {TileId::Wall, "wall", "Wall", 3, false, false, ItemId::Wall, Rgb{94, 90, 82}},
    {TileId::PlankWall, "plank_wall", "Plank Wall", 2, false, false, ItemId::PlankWall, Rgb{132, 82, 42}},
    {TileId::Door, "door",  "Door", 2, false, false, ItemId::Door, Rgb{150, 92, 42}},
    {TileId::StairsUp, "stairs_up", "Stairs Up", 2, true, true, ItemId::StairsUp, Rgb{156, 132, 82}},
    {TileId::StairsDown, "stairs_down", "Stairs Down", 2, true, true, ItemId::StairsDown, Rgb{118, 94, 62}},
...
const std::vector<ItemDef> kItems = {
    ...
    {ItemId::Sand, "sand", "Sand", 100, TileId::Sand, true, MachineKind::Chest, false},
    {ItemId::SandGlass, "sand_glass", "Sand Glass", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::ReedFiber, "reed_fiber", "Reed Fiber", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::CactusFiber, "cactus_fiber", "Cactus Fiber", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::Kelp, "kelp", "Kelp", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::Shell, "shell", "Shell", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::CoralShard, "coral_shard", "Coral Shard", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::IceShard, "ice_shard", "Ice Shard", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::Basalt, "basalt", "Basalt", 100, TileId::Floor, true, MachineKind::Chest, false},
    {ItemId::Crystal, "crystal", "Crystal", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::Hide, "hide", "Hide", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::Bone, "bone", "Bone", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::Slime, "slime", "Slime", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::Venom, "venom", "Venom", 100, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::Scrap, "scrap", "Scrap", 100, TileId::Floor, false, MachineKind::Chest, false},
    {ItemId::MarshHeart, "marsh_heart", "Marsh Heart", 20, TileId::Grass, false, MachineKind::Chest, false},
    {ItemId::GlassHeart, "glass_heart", "Glass Heart", 20, TileId::Grass, false, MachineKind::Chest, false},
    ...
    {ItemId::ArcTower, "arc_tower", "Arc Tower", 20, TileId::Floor, false, MachineKind::ArcTower, true},
    ...
    {ItemId::StairsUp, "stairs_up", "Stairs Up", 20, TileId::StairsUp, true, MachineKind::Chest, false},
...
const std::vector<MachineDef> kMachines = {
    ...
    {MachineKind::ArcTower, "arc_tower", "Arc Tower", 1, 1, false, true, false, 0, MachineBehaviorKind::ArcTower},
};
...
const std::vector<RecipeDef> kRecipes = {
    ...
    {"sand_glass", {ItemStack{ItemId::Sand, 1}, ItemStack{ItemId::Coal, 1}}, ItemStack{ItemId::SandGlass, 1}, 45, "furnace", true},
    {"boat", {ItemStack{ItemId::Wood, 6}, ItemStack{ItemId::ReedFiber, 2}}, ItemStack{ItemId::Boat, 1}, 35, "workbench", true},
    {"plank_wall", {ItemStack{ItemId::Wood, 2}}, ItemStack{ItemId::PlankWall, 2}, 20, "workbench", true},
    {"wall", {ItemStack{ItemId::Stone, 2}}, ItemStack{ItemId::Wall, 2}, 20, "workbench", true},
    {"basalt_wall", {ItemStack{ItemId::Basalt, 2}}, ItemStack{ItemId::Wall, 3}, 25, "workbench", true},
    {"door", {ItemStack{ItemId::Wood, 3}, ItemStack{ItemId::ReedFiber, 1}}, ItemStack{ItemId::Door, 1}, 25, "workbench", true},
    {"stairs_up", {ItemStack{ItemId::Stone, 2}, ItemStack{ItemId::Wood, 1}}, ItemStack{ItemId::StairsUp, 1}, 25, "workbench", true},
    {"stairs_down", {ItemStack{ItemId::Stone, 2}, ItemStack{ItemId::Wood, 1}}, ItemStack{ItemId::StairsDown, 1}, 25, "workbench", true},
...
const std::vector<TechDef> kTechs = {
    ...
    {"logistic_network", "Logistic Network", {ItemStack{ItemId::AdvancedSciencePack, 5}}, 30, {"provider_chest", "requester_chest", "logistic_port", "logistic_drone", "beacon_core", "archive_terminal", "train_stop", "rift_gate", "outpost_beacon", "pressure_relay", "arc_tower"}},
};
...
std::string_view toString(MachineBehaviorKind behavior)
{
    ...
    case MachineBehaviorKind::ArcTower:
        return "arc_tower";
    }
    return "unknown";
}
