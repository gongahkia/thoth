...
Registry.tiles = {
    ...
    archive_wall = { name = "Archive Wall", walkable = false, color = { 36, 34, 42 }, height = 1.7, occluder = true, architecture = true },
    archive_monolith = { name = "Archive Monolith", walkable = false, color = { 54, 48, 64 }, height = 2.25, occluder = true, architecture = true },
    rotation_cache = { name = "Parallax Cache", walkable = true, curio = "relic_cache", color = { 142, 108, 52 }, hiddenBehind = true, revealRotations = { 1 }, rotationPuzzle = true },
    corridor = { name = "Corridor", walkable = true, color = { 64, 62, 70 } },
    salt_floor = { name = "Salt Floor", walkable = true, color = { 72, 90, 92 } },
    salt_wall = { name = "Salt Wall", walkable = false, color = { 34, 48, 54 }, height = 1.55, occluder = true, architecture = true },
    ...
    ember_wall = { name = "Ember Wall", walkable = false, color = { 46, 34, 30 }, height = 1.65, occluder = true, architecture = true },
    ember_corridor = { name = "Ember Corridor", walkable = true, color = { 78, 56, 46 } },
    ash_choke = { name = "Ash Choke", walkable = false, color = { 42, 40, 38 }, height = 1.2, occluder = true, architecture = true },
    sealed_door = { name = "Sealed Door", walkable = false, color = { 84, 62, 44 }, height = 1.45, occluder = true, architecture = true },
...
Registry.tileOrder = {
    "archive_floor", "archive_wall", "archive_monolith", "rotation_cache", "corridor",
    ...
    buried_archive = {
        ...
        layout = {
            ...
            specials = {
                ...
                { x = 8, y = 1, z = 0, tile = "lost_page", hiddenBehind = true },
                { x = 7, y = 1, z = 0, tile = "archive_monolith" },
                { x = 6, y = 2, z = 0, tile = "rotation_cache", hiddenBehind = true, revealRotations = { 1 } },
