...
- UI state, status, mode, tick, and current accessibility settings.
...
- `tests/run.lua` covers color transform, font scale, subtitles, reduced motion, settings persistence, and text export content.
